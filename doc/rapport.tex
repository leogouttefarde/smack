...
\begin{center}
\includegraphics[scale=0.5]{res/eco\_spark.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{res/archi\_spark.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{res/workflow\_spark.png}
\end{center}
...
\includegraphics[scale=0.4]{res/archi\_cass.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{-2.5cm}
\includegraphics[scale=0.5]{res/cli\_cass.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{-2.5cm}
\includegraphics[scale=0.6]{res/model\_cass.png}
\end{wrapfigure}
...
\begin{center}
\includegraphics[scale=0.6]{res/model2\_cass.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.7]{res/spark\_cass.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.8]{res/producer\_consumer.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.8]{res/topic\_kafka.png}
\end{center}
